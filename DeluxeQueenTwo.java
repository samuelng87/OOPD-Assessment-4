...
public class DeluxeQueenTwo extends Room {
	// Attributes
	private double discount = 0.05;
	private String description;

	// Default Constructor
	public DeluxeQueenTwo() {
		super();
		this.description = "";
	}

	// Parameterized Constructor
	public DeluxeQueenTwo(int anID, String aFeatures, double aPrice, String aLocation, String aDescription) {
